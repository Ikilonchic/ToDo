...
import { signUpRequest } from '../hooks/Request.hook';
...
export default class SignUp extends React.Component {
  ...
  signUp() {
    ...
    try {
      ...
      signUpRequest(email, pass).then((response) => {
        ...
        <div className="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
          <form className="login100-form validate-form" >
            ...
            <div className="wrap-input100 validate-input m-b-25" data-validate = "Repeat password">
              <input className="input100" type="password" name="rep-pass" id="rep-pass" placeholder="repeat password" autoComplete="new-password" />
              <span className="focus-input100"></span>
            </div>
  
            <div className="container-form-btn">
              <button type="button" onClick={this.signUp} className="form-btn">
                Sign Up
              </button>
            </div>
  
            <div className="text-center p-t-57 p-b-20">
              <Link className="txt2 hov1" to="/signin">
                Sign In
              </Link>
            </div>
          </form>
